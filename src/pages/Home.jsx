...
export default function Home() {
    ...
    return (
        <>
            <SplashSection splashMessage={'Omran Suleiman'} isDarkMode={isDarkMode} isErrorMode={false} />
            ...
            <section className="w-[100%] flex flex-col flex-nowrap items-center justify-center gap-7 px-mobileBound sm:px-8 sm:gap-8 md:gap-9 lg:gap-10">
                <h2>Contact</h2>
                <Socials />
                <p className="text-center">Are you ready to get your dream website Made? Let&apos;s chat!</p>
                <ContactForm />
            </section>
        </>
    );
